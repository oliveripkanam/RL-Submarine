...
NUM_EPISODES = 50000
MAX_STEPS = 3000
UPDATE_INTERVAL = 8192  # Optimized for stability
BATCH_SIZE = 128
SAVE_INTERVAL = 50
...
def train():
    ...
    for episode in range(start_episode, NUM_EPISODES):
        ...
        hit_wall_this_run = False  # <--- NEW: Track wall hits for Clean/Dirty stats
        ...
        for step in range(MAX_STEPS):
            ...
            if WATCH_MODE:
                # ... (Visual Code Omitted for brevity, unchanged) ...
